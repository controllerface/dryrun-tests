...
public class IOUtils_InputReader extends VulnerableServlet
{
    private static final IOUtils_InputReader servlet = new IOUtils_InputReader();

    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws IOException
    {
        var buffer = IOUtils.buffer(req.getReader());
